...
from LateralSkullRadiographDataset import LateralSkullRadiographDataset
...
class LateralSkullRadiographDataModule(L.LightningDataModule):
    def __init__(
        ...
        self.train_dataset, self.val_dataset, self.test_dataset = random_split(
            self.dataset, self._get_splits(splits)
        )
    ...
    def _get_splits(self, splits: tuple[int, int, int]) -> tuple[int, int, int]:
